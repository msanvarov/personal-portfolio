...
import { NavLink, Link } from "@components/Link/Link";
...
import { navLinks, socialLinks } from "@routes/navigation";
import { reflow } from "utils/transition";
import { AppContext } from "@app/App";

// TODO finish

const ThemeToggle = lazy(() => import("@components/ToggleTheme/ToggleTheme"));
...
const HeaderLogo = styled(Link)<any>`
  display: flex;
  position: relative;
  padding: 10px;
  z-index: 16;
...
const HeaderNavLink: any = styled(NavLink)<any>`
  padding: 20px;
...
const HeaderNavIcon: any = styled(Icon)`
...
const HeaderMobileNav: any = styled.nav<any>`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
