            ...
            <div className="col-md-6" data-aos="zoom-in">
              <div className="about-me-box shadow-box">
                ...
                <div className="infos">
                  ...
                  <Link to={en.landing.bio.button.link} className="about-btn">
                    <img
                  ...
                  <div data-aos="zoom-in">
                    <div className="about-crenditials-box info-box shadow-box h-full">
                      ...
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <Link
                          to={en.landing.credentials.button.link}
                          className="about-btn"
                        >
                          <img
                ...
                <div data-aos="zoom-in">
                  <div className="about-blog-box info-box shadow-box h-full">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <Link
                        to={en.landing.blog.button.link}
                        className="about-btn"
                      >
                        <img
                          src={getThemedContent(
                ...
                <div data-aos="zoom-in" className="flex-1">
                  <div className="about-services-box info-box shadow-box h-full">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <Link
                        to={en.landing.offerings.button.link}
                        className="about-btn"
                      >
                        <img
                          src={getThemedContent(
                ...
                <div data-aos="zoom-in">
                  <div className="about-profile-box info-box shadow-box h-full">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <Link
                        to={en.landing.profiles.button.link}
                        className="about-btn"
                      >
                        <img
                          src={getThemedContent(
          ...
          <div className="row mt-24">
            ...
            <div className="col-md-6" data-aos="zoom-in">
              <div className="about-contact-box info-box shadow-box">
                ...
                />
                <Link to={en.landing.contact.button.link} className="about-btn">
                  <img
                    src={getThemedContent(
                      theme,
